...
## [1.2.0](https://github.com/7K-Inari/inari-server/compare/v1.1.0...v1.2.0) (2026-08-21)
...
* **approvals:** resolve items via GetItemByID; promote yaml.v3 to direct dep ([daf3ee5](https://github.com/7K-Inari/inari-server/commit/daf3ee5bc25f5f06f07d7b8fbdc5c1c4765b9eea))
